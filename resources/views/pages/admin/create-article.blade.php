...
@section('content')
    <div class="title d-flex align-items-center gap-2 mb-4">
        ...
        <h3 class="text-color fw-bold my-0 py-0">Create Artikel</h3>
    </div>

    <form action="{{ route('articles.store') }}" method="post" enctype="multipart/form-data" class="create-article d-flex flex-column gap-3 pb-5 mb-5">
        @csrf
